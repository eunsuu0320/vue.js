...
Content: 이미지 등록. / image_insert => ImageInsert.vue
Created: 최은수
   Date: 2025.07.11
*/
...
export default {
  ...
  created() {
    ...
    this.getProductDetail(); // 상품 상세.
    this.getProductImage(); // 이미지 전체 목록
  },
  methods: {
