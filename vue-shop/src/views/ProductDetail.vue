...
Content: 상품 상세화면, /detail => ProductDetail.vue
Created: 최은수
   Date: 2025.07.11
*/
...
export default {
  ...
  methods: {
    ...
    getCurrencyFormat(price) {
      const krwFormetter = new Intl.NumberFormat("ko-KR", {
        style: "currency",
        currency: "KRW",
      });
      // console.log(krwFormetter.format(price));
      return krwFormetter.format(price);
    },
